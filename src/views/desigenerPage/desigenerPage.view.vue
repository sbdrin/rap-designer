		...
		<div class="page-header-tools">
			...
			<div class="page-header-tools__wrap">
				<ul class="page-header-tools__ul">
					<li class="page-header-tools__ul-item"
						@click="save">保存</li>
					<li class="page-header-tools__ul-item"
						@click="preview">预览</li>
					<li class="page-header-tools__ul-item"
		...
		<div class="desigener-page">
			...
			<div class="desigener-page__item desigener-page__left">
				...
				<div class="desigener-page-layout__wrap">
					<PageScrollbar ref="pageLayoutLeftScrollbar"
				...
				<div class="desigener-page-component__wrap">
					<PageScrollbar ref="pageComponentLeftScrollbar"
								   :options="{ scrollX: false }"
			...
			<div class="desigener-page__item desigener-page__right">
				<el-collapse class="desigener-page__collapse"
							 v-model="collapseValue"
							 accordion>
					<el-collapse-item name="1"
									  title="页面属性:">
						<pageFormView :options="pageOptions"
									  @updateOptions="updatePageFn" />
					</el-collapse-item>
					<el-collapse-item name="2"
									  title="组件属性:"
									  class="component-props">
						<el-tabs v-model="componentTabs"
							...
							<el-tab-pane label="基础配置"
								...
								<div class="desigener-page-basis">
									<PageScrollbar ref="pageComponentBasisScrollbar"
												   :options="{ scrollX: false }"
												   customClassName="desigener-page-component-basis--scrollbar">
										<div>
											<pageFormView :options="currentPluginOptions"
